    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                textAction.contentDescription = getString(R.string.lemon_select)
                lemonImage?.setImageResource(R.drawable.lemon_tree)
            }

            SQUEEZE -> {
                textAction.setText(getString(R.string.lemon_squeeze))
                textAction.contentDescription = getString(R.string.lemon_squeeze)
                lemonImage?.setImageResource(R.drawable.lemon_squeeze)
            }

            DRINK -> {
                textAction.setText(getString(R.string.lemon_drink))
                textAction.contentDescription = getString(R.string.lemon_drink)
                lemonImage?.setImageResource(R.drawable.lemon_drink)
            }

            else -> {
                textAction.setText(getString(R.string.lemon_empty_glass))
                textAction.contentDescription = getString(R.string.lemon_empty_glass)
